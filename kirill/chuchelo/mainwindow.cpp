...
, ui(new Ui::MainWindow)
{
    ...
    imageLabel->setPixmap(QPixmap("C:/For qutezh/chuchelo/mat/11.jpg"));
    ...
    if (event->button() == Qt::LeftButton) {
        ...
        if (imageLabel) {
            ...
            if (clickableRect.contains(cursorPos) && !isImageChanged_) {
                imageLabel->setPixmap(QPixmap("C:/For qutezh/chuchelo/mat/22.jpg"));
                imageLabel->update();
                isImageChanged_ = true;
            }
            else if (clickableRect.contains(cursorPos) && isImageChanged_) {
                imageLabel->setPixmap(QPixmap("C:/For qutezh/chuchelo/mat/33.jpg"));
                imageLabel->update();
            }
        }
    }
