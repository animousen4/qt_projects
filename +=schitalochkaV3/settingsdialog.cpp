    ...
    ui(new Ui::SettingsDialog)
{
    ...
    connect(ui->useDefaultButton, &QPushButton::clicked, this, &SettingsDialog::onUseDefaultClicked);
...
void SettingsDialog::onUseDefaultClicked() {

    settingManager->changeParticipantList(Preset::getDefaultParticipants());
}
